  ...
  useEffect(() => {
    ...
    if (cart.data?.products) {
      cart.data.products.forEach((element) => {
        ...
        localStorage.setItem("total", progressiveTotal);
      });
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <div className="flex gap-4 mt-1 text-sm text-slate-500">
                        ...
                        <span>
                          Quantità:{" "}
                          <b className="text-slate-700">{item.amount}</b>
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          (item.toRemove = parseInt(e.target.value))
                        }
                      />
            ...
            {cart.data?.products?.length > 0 && (
              <div className="mt-10 pt-6 border-t border-slate-100">
                <div className="flex justify-between items-end">
                  ...
                  <Link
                    className="bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-4 rounded-2xl font-bold shadow-lg shadow-emerald-200 hover:shadow-emerald-300 transition-all transform hover:-translate-y-1 active:scale-95 cursor-pointer flex items-center gap-2"
                    to="/checkout"
                  >
                    Procedi al Checkout
                    <FaArrowRightLong />
